                                ...
                                <tbody>
                                    @foreach ($users as $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->member_status == 0 | $item->member_status == 1)
                                                    <a class="btn btn-primary btn-sm" href='/status_update_invite/{{ $item->id }}'>Approve member</a>
                                                    <a class="btn btn-danger btn-sm" href='/status_delete_invite/{{ $item->id }}'>Reject</a>
