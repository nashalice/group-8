                            ...
                            <tr>
                              ...
                              <td>
                                @if($item->application_status == 1)
                                    <a href="loan_approval_a/{{ $item->id }}" class="btn btn-primary btn-sm btn-outline-light" style="background-color: green;">Approve</a href="">
                                    <a href="loan_reject_a/{{ $item->id }}" class="btn btn-primary btn-sm btn-outline-light" style="background-color: red;">Reject</a href="">
                                @elseif ($item->application_status == 0)
                                ...
                                @elseif ($item->application_status == 4 | $item->application_status == 2)
                                    <button class="btn btn-primary btn-sm btn-outline-light" type="button" style="background-color: rgb(0, 255, 8);">Approved</button>
